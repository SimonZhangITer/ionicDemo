            ...
            return {
                ...
                compile: function (tElement, tAttrs, tTransclude) {
                    ...
                    var template = angular.element([
                        ...
                        '<ion-scroll delegate-handle="alphaScroll" scrollbar-y="false">',
                        ...
                        '<div ng-repeat="item in items"><ion-item style="border-bottom: none!important;"><div class="contact-line" ng-if="$index!=(items.length-1)"></div></ion-item></div>',
                        '</div>',
                        '</ion-scroll>',
